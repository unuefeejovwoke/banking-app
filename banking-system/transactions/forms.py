    ...
    def clean_amount(self):
        ...
        if amount < min_deposit_amount:
            raise forms.ValidationError(
                f'You need to deposit at least {min_deposit_amount} NGN'
            )
...
class WithdrawForm(TransactionForm):
    ...
    def clean_amount(self):
        ...
        if amount < min_withdraw_amount:
            raise forms.ValidationError(
                f'You can withdraw at least {min_withdraw_amount} NGN'
            )

        if amount > max_withdraw_amount:
            raise forms.ValidationError(
                f'You can withdraw at most {max_withdraw_amount} NGN'
            )

        if amount > balance:
            raise forms.ValidationError(
                f'You have {balance} NGN in your account. '
